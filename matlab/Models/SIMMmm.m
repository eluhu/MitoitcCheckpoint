function [tY, op, d1MCCt] = SIMMmm(p_laser, p_cutX, k_tens, n)
...
% Sec = Y(6);
% Xtens = Y(7);
initialConditions=[0.47, 0.19, 1.99, 0.98, 0.09, 1.8, 1];
...
parameters=[p_laser, p_cutX, p_Mad2t, p_CAPPt, p_APCt, p_Xt, k_tens, k_aNt, k_u, k_du, k_cat, k_as, k_di, k_scyc, k_dcyc, k_dcycapc, k_an, k_in, k_ssec, k_dsec, k_dsecapc, p_J];
...
dMCCt = k_aNt * kTa * ( p_Mad2t - MCCt)/(p_J + p_Mad2t - MCCt) - k_u * APC * MCCu;
...
%Map 
dYdt = [dCycB; dkTa; dMCCt; dAPCMCC; dMCCu; dSec; dXtens];
