function [tY, op, d1MCCt] = SIMM(p_laser, p_cutX, k_tens, n)
...
parameters=[p_laser, p_cutX, p_Mad2t, p_CAPPt, p_APCt, p_Xt, k_tens, k_aNt, k_u, k_du, k_cat, k_as, k_di, k_scyc, k_dcyc, k_dcycapc, k_an, k_in, k_ssec, k_dsec, k_dsecapc];
...
dMCCt = k_aNt * kTa * ( p_Mad2t - MCCt) - k_u * APC * MCCu;
